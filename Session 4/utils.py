...
train_data_path = 'data/w2v/20news-train-raw.txt'
test_data_path = 'data/w2v/20news-test-raw.txt'
data_path = 'data/w2v/vocab-raw.txt'



# encode_data(train_data_path, data_path)
# encode_data(test_data_path, data_path)